...
namespace Microsoft.Extensions.Hosting
{
    ...
    public static class MigrateDbContextExtensions
    {
        ...
        public static async Task<IHost> MigrateDbContext<THost, TContext>(this Task<THost> hostTask, AsyncSeedMethod<TContext> seeder)
            where THost : IHost
        ...
        /// <param name="seeder">The seed delegate.</param>
        /// <returns>A task that represents the asynchronous migration operation.</returns>
        public static async Task<IHost> MigrateDbContext<THost, TContext>(this Task<THost> hostTask, SeedMethod<TContext> seeder)
            where THost : IHost
            where TContext : DbContext
        {
            var host = await hostTask;
        ...
        /// <param name="hostTask">The task that can be awaited to get the host.</param>
        /// <returns>A task that represents the asynchronous migration operation.</returns>
        public static async Task<IHost> MigrateDbContext<THost, TContext>(this Task<THost> hostTask)
            where THost : IHost
            where TContext : DbContext
        {
            var host = await hostTask;
        ...
        /// <param name="hostTask">The task that can be awaited to get the host.</param>
        /// <returns>A task that represents the asynchronous migration operation.</returns>
        public static async Task<IHost> MigrateDbContext<TContext>(this Task<ElseExecuteHost> hostTask)
            where TContext : DbContext
        {
            var host = await hostTask;
            return await host.MigrateDbContext<TContext>();
        ...
        /// <param name="seeder">The seed delegate.</param>
        /// <returns>A task that represents the asynchronous migration operation.</returns>
        public static async Task<IHost> MigrateDbContext<TContext>(this Task<IHost> hostTask, AsyncSeedMethod<TContext> seeder)
            where TContext : DbContext
        {
            var host = await hostTask;
            return await host.MigrateDbContext(seeder);
        ...
        /// <param name="seeder">The seed delegate.</param>
        /// <returns>A task that represents the asynchronous migration operation.</returns>
        public static async Task<IHost> MigrateDbContext<TContext>(this Task<IHost> hostTask, SeedMethod<TContext> seeder)
            where TContext : DbContext
        {
            var host = await hostTask;
            return await host.MigrateDbContext(seeder);
